...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"addGame\": () => (/* binding */ addGame),\n/* harmony export */   \"refreshGame\": () => (/* binding */ refreshGame)\n/* harmony export */ });\n/* harmony import */ var _selector_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./selector.js */ \"./src/modules/selector.js\");\n\r\n\r\nconst gameID = 'XBSpv4i1UxPqI7BMlV9R';\r\n\r\nconst addGame = async (e) => {\r\n  e.preventDefault();\r\n  const username = _selector_js__WEBPACK_IMPORTED_MODULE_0__.name.value;\r\n  const userscore = _selector_js__WEBPACK_IMPORTED_MODULE_0__.score.value;\r\n  const url = `${_selector_js__WEBPACK_IMPORTED_MODULE_0__.baseurl}/games/${gameID}/scores/`;\r\n  await fetch(url, {\r\n    method: 'POST',\r\n    headers: {\r\n      'Content-Type': 'application/json',\r\n    },\r\n    body: JSON.stringify({\r\n      user: username,\r\n      score: userscore,\r\n    }),\r\n  });\r\n  _selector_js__WEBPACK_IMPORTED_MODULE_0__.name.value = '';\r\n  _selector_js__WEBPACK_IMPORTED_MODULE_0__.score.value = '';\r\n};\r\n\r\nconst refreshGame = async () => {\r\n  const url = `${_selector_js__WEBPACK_IMPORTED_MODULE_0__.baseurl}/games/${gameID}/scores/`;\r\n  const response = await fetch(url);\r\n  const data = await response.json();\r\n  _selector_js__WEBPACK_IMPORTED_MODULE_0__.ul.innerHTML = '';\r\n  data.result.forEach((el) => {\r\n    const li = document.createElement('li');\r\n    li.textContent = `${el.user} : ${el.score}`;\r\n    _selector_js__WEBPACK_IMPORTED_MODULE_0__.ul.appendChild(li);\r\n  });\r\n};\r\n\r\n\r\n\n\n//# sourceURL=webpack://leader-board/./src/modules/createGame.js?");
...
eval("module.exports = __webpack_require__.p + \"529240998d197a6bf0c0.png\";\n\n//# sourceURL=webpack://leader-board/./src/img/flowers.png?");
